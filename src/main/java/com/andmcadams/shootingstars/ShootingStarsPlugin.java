...
public class ShootingStarsPlugin extends Plugin
{
	...
	{
		log.info("Shooting Stars started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Shooting Stars stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Shooting Stars says " + config.greeting(), null);
		}
	}
